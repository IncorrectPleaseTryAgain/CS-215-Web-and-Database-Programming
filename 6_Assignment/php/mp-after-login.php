...
<body>
    ...
    <header class="page-header">
        ...
        <nav class="page-header-nav">
            ...
            <form action="includes/qcreation.inc.php" method="post" class="search-form" id="question-creation-form" enctype="multipart/form-data">
    ...
    <script src="../jss/mpAfterLoginRefresh.js"></script>
