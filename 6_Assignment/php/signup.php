    ...
    <main class="page-main page-main-signup">
        ...
        <form id="signup-form" action="includes/signup.inc.php" method="post" enctype="multipart/form-data" class="card signup-card">
            ...
            <section class="signup-card-body">
                ...
                <input class="signup-input" type="text" id="input-username" name="uname" placeholder="username..." value="<?=isset($_SESSION['uname']) ? $_SESSION['uname'] : null?>"/>
                <p class="error-message hidden" id="err-msg-username">Username Invalid</p>

                <label for="email">Email:</label>
                <input class="signup-input" type="text" id="input-email" name="email" placeholder="email..." value="<?=isset($_SESSION['email']) ? $_SESSION['email'] : null?>"/>
                ...
                <input class="signup-input" type="date" id="input-dob" name="dob" value="<?=isset($_SESSION['dob']) ? $_SESSION['dob'] : null?>"/>
